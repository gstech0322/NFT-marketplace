...
const WalletInfo = () => {
  ...
  const connectWallet = async () => {
    ...
    const jsonRpcProvider = new ethers.providers.JsonRpcProvider(process.env.REACT_APP_JSON_RPC_URL)
  ...
  // const onAccountsChanged = async (newAddress) => {
  //   console.log('acounts changed')
  //   dispatch({
  //     type: 'SET_CONNECTED_WALLET_ADDRESS',
  //     payload: newAddress,
  //   })
  // }
